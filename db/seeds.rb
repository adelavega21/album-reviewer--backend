...
thriller = Album.create(artist_id: michael.id, title: 'Thriller', likes: "100 likes", dislikes: "0 dislikes", year: 1982, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/5/55/Michael_Jackson_-_Thriller.png')
bad = Album.create(artist_id: michael.id, title: 'Bad', likes: "80 likes", dislikes: "2 dislikes", year: 1987, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/thumb/5/51/Michael_Jackson_-_Bad.png/220px-Michael_Jackson_-_Bad.png')
eShow = Album.create(artist_id: eminem.id, title: 'The Eminem Show', likes: "50 likes", dislikes: "20 dislikes", year: 2002, genre: 'Rap', image: 'https://images-na.ssl-images-amazon.com/images/I/61jxguiMreL._SL1200_.jpg')
encore = Album.create(artist_id: eminem.id, title: 'Encore', likes: "60 likes", dislikes: "0 dislikes", year: 2004, genre: 'Rap', image: 'https://e.snmc.io/i/600/w/0f17fa189f48485d75370965044c3dee/1311548')
mWorld = Album.create(artist_id: justin.id, title: 'My World 2.0', likes: "0 likes", dislikes: "100 dislikes", year: 2010, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/b/b9/Myworld2.jpg')
believe = Album.create(artist_id: justin.id, title: 'Believe', likes: "10 likes", dislikes: "80 dislikes", year: 2012, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/0/01/Believe-JB-Album.jpg')
nineteen = Album.create(artist_id: adele.id, title: "19", likes: "90 likes", dislikes: "20 dislikes", year: 2008, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/f/f8/Adele_-_19.png')
twentyOne = Album.create(artist_id: adele.id, title: "21", likes: "80 likes", dislikes: "20 dislikes", year: 2011, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/1/1b/Adele_-_21.png')
twentyFive = Album.create(artist_id: adele.id, title: "25", likes: "90 likes", dislikes: "20 dislikes", year: 2015, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/9/96/Adele_-_25_%28Official_Album_Cover%29.png')
starsDance = Album.create(artist_id: selena.id, title: "Stars Dance", likes: "20 likes", dislikes: "70 dislikes", year: 2013, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/f/f1/Stars_Dance.png')
revival = Album.create(artist_id: selena.id, title: "Revival", likes: "5 likes", dislikes: "23 dislikes", year: 2015, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/4/42/Selena_Gomez_-_Revival_%28Official_Deluxe_Cover%29.png')
rare = Album.create(artist_id: selena.id, title: "Rare", likes: "57 likes", dislikes: "21 dislikes", year: 2020, genre: 'Pop', image: 'https://upload.wikimedia.org/wikipedia/en/d/d1/Selena_Gomez_-_Rare.png')
...
Comment.create(album_id: thriller.id, content: "Great Album! Classic!")